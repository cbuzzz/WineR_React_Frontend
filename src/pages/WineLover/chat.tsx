...
const Chat: React.FC = () => {
    ...
    useEffect(() => {
        ...
        newSocket.on('message-receive', (newMessage: any) => {
            // Limpia el contenido del mensaje antes de agregarlo al estado
    ...
    },  [cleanText]); // Asegúrate de que useBadWords se esté llamando correctamente
        ...
        if (roomName) {
            ...
            const fetchMessages = async () => {
                try {
                    ...
                    // Limpia el contenido de todos los mensajes previos
                    const cleanedMessages = previousMessages.map((msg) => ({
                        ...msg,
    ...
    const handleSendMessage = () => {
        if (message.trim() && roomName) {
            // Limpia el mensaje antes de enviarlo
